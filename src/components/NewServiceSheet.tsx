    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-md overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>Crie um novo atendimento para a equipe.</SheetDescription>
        </SheetHeader>
        <form onSubmit={handleSubmit} className="space-y-4 mt-6">
          <div className="space-y-2">
            <Label htmlFor="title">Título do Atendimento</Label>
            <Input
              id="title"
              value={title}
          ...
          <div className="space-y-2">
            <Label htmlFor="priority">Prioridade do Atendimento</Label>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Descreva o novo atendimento..."
